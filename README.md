...
A testing ground for ant colony optimization algorithms in a physical, 2D space.

The code is designed with glfw and expected to be compiled with msys2 on VS code as according to the tasks.json file.
Once running there are two modes, preparing and running:
